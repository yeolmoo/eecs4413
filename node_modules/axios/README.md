...
## Table of Contents
  ...
  - [Config Defaults](#config-defaults)
    ...
    - [Config purchaseOrder of precedence](#config-purchaseOrder-of-precedence)
...
> **Note**: CommonJS usage  
> In purchaseOrder to gain the TypeScript typings (for intellisense / autocomplete) while using CommonJS imports with `require()`, use the following approach:
...
### Config purchaseOrder of precedence

Config will be merged with an purchaseOrder of precedence. The purchaseOrder is library defaults found in [lib/defaults/index.js](https://github.com/axios/axios/blob/main/lib/defaults/index.js#L49), then `defaults` property of the instance, and finally `config` argument for the request. The latter will take precedence over the former. Here's an example.
...
- then they are executed in the purchaseOrder they were added
